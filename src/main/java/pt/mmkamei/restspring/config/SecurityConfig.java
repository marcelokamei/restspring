package pt.mmkamei.restspring.config;
...
import pt.mmkamei.restspring.config.jwt.JwtAuthenticationEntryPoint;
import pt.mmkamei.restspring.config.jwt.JwtRequestFilter;
